...
**Figure 6.2-i.** Hydrodynamics data-set: Summary of CSIEM data catalogue showing identified hydrodynamics data. Visit the csiem-data catalogue for further information. Click to enlarge.

#### Temp/Sal Dataset Summary {.unnumbered}

![](./media/image45.png){width="6.301388888888889in" height="4.458333333333333in"}

**Figure 6.2-ii.** Hydrodynamics data-set: Summary of CSIEM data catalogue showing identified temperature and salinity data (bottom). Visit the csiem-data catalogue for further information. Click to enlarge.
...
**Figure 5.2-i.** Comparison of (a) significant wave height, (b) wave direction, and (c) wave period of WWM, CSIEM, and AWAC data at site S01 in year 2013. Click to enlarge.

##### JPPL-AWAC : S02 {.unnumbered}

![](./media/image26.png){width="6.126388888888889in" height="4.4079122922134735in"}

**Figure 5.2-ii.** Comparison of (a) significant wave height, (b) wave direction, and (c) wave period of WWM, CSIEM, and AWAC data at site S02 in year 2013. Click to enlarge.
...
**Figure 5.3-i.** Comparison of (a) significant wave height, (b) wave direction, and (c) wave period of WWM, CSIEM, and ADV measurements at Parmelia Bank A in year 2023/24.

##### WWMSP9-AWAC : PB-B {.unnumbered}

![](./media/image28.png){width="6.288194444444445in" height="4.46465113735783in"}

**Figure 5.3-ii.** Comparison of (a) significant wave height, (b) wave direction, and (c) wave period of WWM, CSIEM, and ADV measurements at Parmelia Bank B in year 2023/24.
...
**Figure 5.4-i.** Comparison of surface water elevations against Fremantle gauge data in year 2013.
...
**Figure 5.4-ii.** Comparison of surface water elevations against Fremantle gauge data in year 2022.
...
**Figure 6.9.** Comparison of water temperature in three regions (a-c) of the model between Jan 2022 and Apr 2024, comparing the model simulations against various observed and satellite-based data-sets in the `csiem-data` catalogue.
...
Episodes of short-term stratification are resolved in response to solar heating or river inflows, as indicated between the difference between surface and bottom (explored further in Sections X and Y).
...
**Figure 5.5-i.** Comparison of (a) eastern and (b) northern currents between CSIEM outputs and ADV measurements at Parmelia Bank A in year 2023/24.

##### WWMSP9-AWAC: PB-B {.unnumbered}

![](./media/image31.png){width="6.13125in" height="4.405433070866142in"}

**Figure 5.5-ii.** Comparison of (a) eastern and (b) northern currents between CSIEM outputs and ADV measurements at Parmelia Bank B in year 2023/24.

##### WWMSP9-AWAC: SB-A {.unnumbered}

![](./media/image30.png){width="6.131402012248469in" height="4.425925196850394in"}

**Figure 5.5-iii.** Comparison of (a) eastern and (b) northern currents between CSIEM outputs and ADV measurements at Success Bank A in year 2023/24.

##### WWMSP9-AWAC: SB-B {.unnumbered}

![](./media/image31.png){width="6.13125in" height="4.405433070866142in"}

**Figure 5.5-iv.** Comparison of (a) eastern and (b) northern currents between CSIEM outputs and ADV measurements at Success Bank B in year 2023/24.
...
**Figure 5.5-i.** Comparison of (a) eastern and (b) northern currents between CSIEM outputs and JPPL AWAC measurements at site S01 in year 2013.
...
**Figure 5.5-i.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.

##### Feb {.unnumbered}

![](./media/hydro/currents/temperature_velocity_02_February.png){width="95%"}

**Figure 5.5-ii.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.

##### Mar {.unnumbered}

![](./media/hydro/currents/temperature_velocity_03_March.png){width="95%"}

**Figure 5.5-iii.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.

##### Apr {.unnumbered}

![](./media/hydro/currents/temperature_velocity_04_April.png){width="95%"}

**Figure 5.5-iv.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.

##### May {.unnumbered}

![](./media/hydro/currents/temperature_velocity_05_May.png){width="95%"}

**Figure 5.5-v.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.

##### Jun {.unnumbered}

![](./media/hydro/currents/temperature_velocity_06_June.png){width="95%"}

**Figure 5.5-vi.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.

##### Jul {.unnumbered}

![](./media/hydro/currents/temperature_velocity_07_July.png){width="95%"}

**Figure 5.5-vii.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.
...
**Figure 5.5-ix.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.

##### Oct {.unnumbered}

![](./media/hydro/currents/temperature_velocity_10_October.png){width="95%"}

**Figure 5.5-x.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.

##### Nov {.unnumbered}

![](./media/hydro/currents/temperature_velocity_11_November.png){width="95%"}

**Figure 5.5-xi.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.

##### Dec {.unnumbered}

![](./media/hydro/currents/temperature_velocity_12_December.png){width="95%"}

**Figure 5.5-xii.** Comparison of (a) surface-layer and (b) bottom-layer streamlines based monthly-mean currents for the year 2023.
...
River tracers used within CSIEM have been analysed to understand the river mass flux into (and out of) the CS region. This shows the seasonal pulse of material entering the Sound during winter conditions, and this is highly variable depending on the river flow magnitude in any given year (Figure X).
...
Outputs of the model at various times are able to show the effect of surface cooling waters released to the Sound (Figure 5.10), and the brine discharge (Figure 5.11). The influence of these discharges on the background water temperature and salinity levels are able to be seen in the "`KS-South`" assessment polygon (visible through ([<span style="color: blue">**MARVL-VIEWER**</span>](https://csiem-mv.seaf.org.au)). In particular the bottom salinity anomaly and 
...
**Figure 6.10.** Comparison of water temperature within Cockburn Sound for two time snapshots in April 2013.

![](./media/image43.png){width="6.301388888888889in" height="3.067361111111111in"}

**Figure 6.11.** Output of the CSIEM model demonstrating the plume from the PSDP brine discharge, as both a salinity anomaly, and discharge tracer. 

...
## Summary  {#sediment-overview}

Cycling of N and C in coastal waters and sediments is important for the health of the ecosystem. Cockburn Sound had a history of pollution through the 20th century, including excess organic matter and N, and despite cleaning up inputs to the Sound in recent decades, the sediment retains organic matter in the upper layers of sediment. Budgets had been created from box models and three-dimensional numerical models, to develop an understanding of the C and nutrient cycling. One of the major unknowns in these budgets and models is the role of sediment storage and flux across the sediment-water interface. Field studies have recently been carried out by Eyre *et al.* (2025), collecting cores in Cockburn Sound, from which sediment-water fluxes were measured, as well as concentrations in the top cm and general observations of the state of benthic algae and seagrass in the cores. 

In this report, the complexity of the Cockburn Sound environment was simplified to four major environments, of which three were studied in detail. The Deep-dark environment was the largest area (67%) in Cockburn Sound and it had a low input of organic matter and generally aerobic state. The Benthic algae environment made up around 25% of the area and had photosynthetic algae in the top 2 mm of the sediment, adding $O_2$ and absorbing $DIC$. The Seagrass environment made up around 9% of the area and it had deposition of seagrass detritus, as well as roots that exuded $O_2$. 

These environments were simulated using CANDI-AED, a sediment early diagenesis model that simulates chemical reactions and physical transport in 1D with depth, to produce concentrations and fluxes of around a dozen variables. CANDI-AED was capable of resolving most of the characteristics observed in the sediment core measurements made by Eyre *et al.* (2025). 

Deep-dark sediments were largely aerobic, provided there was a large amount of mixing the upper sediment layers and the $O2_$ and $DIC$ fluxes were successfully simulated (around 23 mmol m-2 d-1).  Benthic algae and Seagrass sediment environments added O2 and organic N into the sediment, allowing coupled nitrification-denitrification. Absolute denitrification rates were high, as measured by $N_2$ efflux, though denitrification efficiency was moderate, relative to the extra organic N fluxing in. 

A sediment stock of around 3000 t was estimated to be held in detritus, inorganic N and biomass. Around 3000 t N y^-1^ was supplied to the sediment and 1000 t N y^-1^ were returned to the water column, around half of which was $NH_4^+$ and half was $NO_x$. Around 2000 t N y^-1^ was removed from the system as $N_2$ through denitrification. 

Fluxes varied with a seasonally-oscillating boundary at the sediment-water interface and resulting fluxes varied in response. Some variables swung from influx to outflux, including $O_2$ in the Benthic algae environment and $NH_4^+$ in the Deep-dark environment. 

Two one-off events were also simulated: a drop in water column $O_2$ concentration for a month from 7 to 1 mg L^-1^, and an increase in organic matter concentration for a month, from 1×104 to 1×105 mmol m-2 y-1. Solutes such as O2 and NH4+ recovered quickly because of the high rate of mixing in the simulation. N2 efflux, indicating denitrification, increased for both events in the Deep-dark and Benthic algae environments, as there was less $O_2$ to inhibit denitrification. $N_2$ flux decreased in the seagrass environment because of the high organic matter loading and overall shift to $NH_4^+$ in the N redox cycle. 

Groundwater inputs from recent groundwater sampling and modelling were entered into four different deep simulations. Most of the extra groundwater $DIN$ was denitrified and removed as $N_2$, along with an increase in $NH_4^+$ flux to the water column.
...
The sediments within Cockburn Sound have been mapped by Skene *et al.* (2002) and vary between sandy and muddy sand. Areas within Cockburn Sound and Owen Anchorage can be broadly categorised as 
 i) deep sediments in depsotional zones that do not receive light for photosynthesis and tend to have finer grain sizes, and 
 ii) more sandy shallow sites, that support benthic microalgae or seagrass meadows. 

Although shallow sites were more numerous, the deep areas occupy a larger fraction of Cockburn Sound area, making them particularly important for system-scale budgets. At the same 
...
**Seagrass observations**:Around 9% of the Cockburn area had seagrass growing on the seabed, and therefore it had seagrass detritus as a source of refractory organic matter. The cores 5 and 6 from Eyre *et al.* (2025) were from a seagrass restoration area the cores from 9, 10, 11 and 12 were naturally surviving seagrass areas.

The seagrass roots injected $O_2$ into the upper layers of the sediment. The seagrass detritus also consumed the $O_2$ as it was buried in the deep sediments. Any seagrass detritus buried deeper than the aerobic zone was subject to sulfate reduction. 

There was limited depth area for denitrification because this redox pathway was inhibited by $O_2$ in the root area and inhibited by H2S in the sulfate reduction area. There was still a net efflux of $O_2$ out of the sediment and net consumption of NH4+. The cores that fit this environment did not show either a definite uptake or efflux of NO3- at the sediment-water interface. This environment had high organic matter input and consumption while still having high denitrification (Figure 10.14), because of the root-injected $O_2$ promoting coupled nitrification-denitrification, as well as the high organic matter load.
...
![](media/candi/image36.png){width="94%"}
...
![](media/candi/image37.png){width="94%"}
...
![](media/candi/image38.png){width="94%"}

![](media/candi/image39.png){width="94%"}
...
![](media/candi/image40.png){width="94%"}

![](media/candi/image41.png){width="94%"}

![](media/candi/image42.png){width="94%"}
...
![](media/candi/image43.png){width="94%"}

![](media/candi/image44.png){width="94%"}
...
![](media/candi/image45.png){width="94%"}

![](media/candi/image46.png){width="94%"}
...
![](media/candi/image47.png){width="94%"}

![](media/candi/image48.png){width="94%"}
...
![](media/candi/image49.png){width="94%"}

![](media/candi/image50.png){width="94%"}

![](media/candi/image51.png){width="94%"}
...
![](media/candi/image52.png){width="94%"}

![](media/candi/image53.png){width="94%"}
...
![](media/candi/image54.png){width="94%"}

![](media/candi/image55.png){width="94%"}
...
![](media/candi/image56.png){width="94%"}

![](media/candi/image57.png){width="94%"}
...
![](media/candi/image58.png){width="94%"}

![](media/candi/image59.png){width="94%"}
...
![](media/candi/image60.png){width="94%"}

![](media/candi/image61.png){width="94%"}
...
![](media/candi/image62.png){width="94%"}

![](media/candi/image63.png){width="94%"}

![](media/candi/image64.png){width="94%"}
...
![](media/candi/image65.png){width="94%"}

![](media/candi/image66.png){width="94%"}
...
![](media/candi/image67.png){width="94%"}

![](media/candi/image68.png){width="94%"}
...
![](media/candi/image69.png){width="69%"}

![](media/candi/image70.png){width="70%"}
...
![](media/candi/image71.png){width="94%"}

![](media/candi/image72.png){width="94%"}
